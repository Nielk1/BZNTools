...
namespace BZNParser.Battlezone.GameObject
{
    ...
    public class ClassScavengerH : ClassDeployable
    {
        ...
        public static void Hydrate(BZNFileBattlezone parent, BZNStreamReader reader, ClassScavengerH? obj)
        {
            if (parent.SaveType != SaveType.BZN)
            {
                ...
                if (reader.Version >= 1109)
                {
                    ...
                    if (obj != null) obj.buildMatrix = tok.GetMatrix();
                }
        ...
        public static void Dehydrate(ClassScavengerH obj, BZNFileBattlezone parent, BZNStreamWriter writer, bool binary, bool save, bool preserveMalformations)
        {
            if (parent.SaveType != SaveType.BZN)
            {
